...
public class ExecuteTerminalCommandPacket implements IMessage {
    private String command;
    private BlockPos terminalPos;

    public ExecuteTerminalCommandPacket() {}

    public ExecuteTerminalCommandPacket(String command, BlockPos terminalPos) {
    ...
    public static class Handler implements IMessageHandler<ExecuteTerminalCommandPacket, IMessage> {
        @Override
        public IMessage onMessage(ExecuteTerminalCommandPacket message, MessageContext ctx) {
